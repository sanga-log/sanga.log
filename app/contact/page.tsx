...
const contacts = [
  ...
  {
    label: 'LINKEDIN',
    value: 'linkedin.com/in/sanga-log',
        ...
        <div className="flex flex-col">
          {contacts.map((contact) => (
            <a
              ...
              rel="noreferrer"
              className="border-b border-black py-6 flex items-center justify-between hover:opacity-50 transition-opacity"
            >
